...
add_action( 'widgets_init', 'xc360_followus_widget' );

/**
 * Register the Follow Us Widget
 */
function xc360_followus_widget() {
...
class Followus extends WP_Widget {
    ...
    function __construct(){
        parent::__construct(
                'followus', // Base ID
                __( 'Xc360 - Follow Us', 'xc360' ), // Name
                array('description' => __( 'Custom follow us widget', 'xc360' )) // Args
        );
    }
...
<?php
    ...
    ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'xc360' ); ?></label> 
