...
wp_reset_query();
wp_reset_postdata(); 
$ebook_title = get_sub_field('ebook_title');
$ebook_sub_title = get_sub_field('ebook_sub_title');
                ...
                <div class="ebook-content-wrap">
                    <div class="ebook-content">
                        <?php if(!empty($ebook_title)){ ?>
                            <h3><?php echo $ebook_title; ?></h3>
                        <?php } ?>
                        <?php if(!empty($ebook_sub_title)){ ?>
                            <h6><?php echo $ebook_sub_title; ?></h6>
                        <?php } ?>
                    </div>
